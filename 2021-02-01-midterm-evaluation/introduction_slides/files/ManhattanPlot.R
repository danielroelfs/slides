...
set.seed(12)
gwas.dat <- simulateGWAS(nSNPs = 5e4, nSigCols = 2, SigCHR = c(4,7))
...
manhplot <- ggplot(gwas.dat, aes(x = BPcum, y = -log10(P), size = -log10(P))) +
...
print(manhplot)
ggsave("manhattan.png", manhplot, width = 10, height = 6, dpi = 600, units = "cm", bg = "transparent")
